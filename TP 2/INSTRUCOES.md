# Instruções de Uso - PresenteFácil 2.0
...
**Solução**: Certifique-se de estar na pasta "NOSSO TRABALHO TP 2" e que os arquivos foram compilados corretamente.
...
8. (A) Acrescentar produto → (1) Buscar por GTIN
   - GTIN-13: 7898742841332
   - Confirmar: S
   - Quantidade: 1
...
**PresenteFácil 2.0** - Sistema de Gestão de Listas de Presentes
Desenvolvido como parte do TP2 de Algoritmos e Estruturas de Dados III
