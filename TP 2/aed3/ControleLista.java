...
public class ControleLista {
    ...
    public ControleLista(Scanner scanner) throws Exception {
        ...
        this.visao = new VisaoLista(scanner);
    }

    // Construtor de compatibilidade para classes de teste/legado
    public ControleLista() throws Exception {
        this(new Scanner(System.in));
    }

    public int criarLista(Lista lista) throws Exception {
        // Garante que a lista tenha um codigo compartilhavel gerado
